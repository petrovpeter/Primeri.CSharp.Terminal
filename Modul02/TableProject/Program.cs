...
namespace TableProject
{
	class MainClass
	{
		...
		public static void Main (string[] args)
		{
			...
			table[0, (int) ti.ime] = "Петър"; table[0, (int) ti.familia] = "Петров"; table[0, (int) ti.godini] = "52";

			//Въвеждане на втори ред
			table[1, (int) ti.ime] = "Петров"; table[1, (int) ti.familia] = "Петър"; table[0, (int) ti.godini] = "50";
